...
const Hero = () => {
  ...
  const HeroButton = styled(Button)(({ theme, text }) => ({
    padding: "20px 40px",
    background: text === "contained" ? theme.palette.secondary.main : "#fff",
    borderRadius: "50px",
    color: text === "contained" ? "#fff" : theme.palette.secondary.main,
  ...
  return (
    <Box sx={{ height: "auto" }}>
      ...
      >
        <HeroBox>
          <HeroTextBox>
            <Typography variant="h2" color={theme.palette.headlines.main}>
            ...
            <HeroButton variant="contained" text="contained" sx={{}}>
              Start Your Journey
            </HeroButton>
          </HeroTextBox>
          <HeroImageBox>
